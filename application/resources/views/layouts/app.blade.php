...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-167849652-1"></script>

        <!-- adsense -->
        <script data-ad-client="ca-pub-1172851165593409" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    </head>
    <body>
        <div class="mywrap" style="margin-bottom:30px">
            <header class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @endauth
                    <li class="nav-item">
                        <a class="nav-link" href="/top-tips">Top Tips</a>
                    </li>
                    <li class="nav-item">
                    ...
                    @csrf
                        <input class="form-control mr-sm-2 mb-0" type="email" placeholder="Email" aria-label="Email" value="{{ old('email') }}" name="email">
                        <input class="form-control mr-sm-2 mb-0" type="password" placeholder="Password" aria-label="Password" name="password">
                        <button class="btn btn-outline-success form-control my-2 my-sm-0" type="submit">Login</button>
